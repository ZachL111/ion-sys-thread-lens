...
`ion-sys-thread-lens` is centered on systems programming work in R. The technical target is: Build an R toolkit that studies thread behavior through deny and allow fixtures, with explainable decision traces and bounded memory input sets.
