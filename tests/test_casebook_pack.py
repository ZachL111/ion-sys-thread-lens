"""Regression checks for the ion-sys-thread-lens casebook."""
...
from casebook.harness import assert_expected, ion_sys_thread_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_sys_thread_lens_summary(), assert_expected())
